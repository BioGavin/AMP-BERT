...
#
#   bash scripts/run_escape.sh                 # full run (5 epochs)
...
python scripts/train_escape.py --epochs "$EPOCHS" --model-dir "$MODEL_DIR"

echo "==> Testing on ESCAPE"
python scripts/test_escape.py --model-dir "$MODEL_DIR"
